# Historical Categorical Model Architecture

> **Archived:** This document records the initial categorical baseline and the
> subsequent model-development progression. It is not the current architecture
> guide. See `docs/model-architecture.md` and `docs/repository-map.md`.
