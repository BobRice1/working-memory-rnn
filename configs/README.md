...
|---|---|---|
| `fixation_circular_variable_distractor_working_memory.yaml` | Current distractor baseline | Ten retained one-item circular checkpoints trained across five variable distractor timings. |
